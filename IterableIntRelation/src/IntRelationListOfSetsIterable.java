...
/**
 * An implementation of Iterable and extension of IntRelationListOfSets
 * 
 * @author bogdanfloris
 * 
    ...
    public Iterator<IntPair> iterator() {
        Iterator<IntPair> iter = new Iterator<IntPair>() {
            ...
            public boolean hasNext() {
                while (currentIndex < extent() * extent() && !relation.get(currentIndex / extent()).contains(currentIndex % extent())) {
                    currentIndex++;
                }
