...
//# BEGIN TODO Implementations of test cases for powerize(int)
    ...
    // Random tests
    @Test
    public void powerizeTest2(){
        checkPowerize(10, 2);
    }
    @Test
    public void powerizeTest3(){
        checkPowerize(10, 6);
    }
    @Test
    public void powerizeTest4(){
        checkPowerize(5, 10);
    }
    @Test
    public void powerizeTest5(){
        checkPowerize(3, 6);
    }
    @Test
    public void powerizeTest6(){
        checkPowerize(11, 3);
    }
    
    /**
     * Checks whether illegal parameter n throw expected exception
     * 
     * @param n the number to be powerized
     */
    private void checkParameter(int n, Class expected){
        try {
    ...
    /**
     * Test for exception: n < 2
     */
    @Test
    public void testPowerizeIllegalArgument1(){
        checkParameter(1, IllegalArgumentException.class);
    }
    /**
     * Test for exception: n < 2
     */
    @Test
    public void testPowerizeIllegalArgument2(){
        checkParameter(-1, IllegalArgumentException.class);
    }
    /**
     * Test for exception: n < 2
     */
    @Test
    public void testPowerizeIllegalArgument3(){
        checkParameter(-15, IllegalArgumentException.class);
    }
//# END TODO
